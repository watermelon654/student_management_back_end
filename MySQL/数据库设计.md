...
1. 学生信息表stu_info（**id**，num学号，name姓名，sex性别，year_id学年ID，major_id专业ID，class_id学苑ID，email邮箱，passwd密码）
   ...
   ![image-20230521120207164](..\MySQL\img\image-20230521120207164.png)
...
2. 职工表staff_info（**id**，num职工号，name姓名，sex性别，job职位，level级别，email邮箱，passwd密码）
   ...
   ![image-20230521120225914](..\MySQL\img\image-20230521120225914.png)
...
3. 学习成绩表grade（**id**，<u>stu_id</u>, stu_num学号，stu_name姓名class_id学苑ID，gpaGPA，status状态，score分数，note备注）
   ...
   ![image-20230521120245452](..\MySQL\img\image-20230521120245452.png)
...
4. 志愿服务表volunteer（**id**，<u>stu_id</u>, stu_num学号，stu_name姓名，time服务时长，score分数，status状态，note备注）
   ...
   ![image-20230521120341071](..\MySQL\img\image-20230521120341071.png)
...
5. 科研情况表science（**id**，<u>stu_id</u>, stu_num学号，stu_name姓名，title参与的科研项目的名称、director负责人、constitution组织机构、level项目级别、time参与时间、result项目成果，score分数，status状态）
   ...
   ![image-20230521120413260](..\MySQL\img\image-20230521120413260.png)
...
![image-20230521120429125](..\MySQL\img\image-20230521120429125.png)
...
![image-20230521120454362](../MySQL/img/image-20230521120454362.png)
...
![image-20230521120508585](..\MySQL\img\image-20230521120508585.png)
...
![image-20230521120525144](..\MySQL\img\image-20230521120525144.png)
...
<img src="..\MySQL\img\image-20230512223516394.png" alt="image-20230512223516394" style="zoom:50%;" />
...
<img src="..\MySQL\img\image-20230512224725189.png" alt="image-20230512224725189" style="zoom:50%;" />
...
<img src="..\MySQL\img\image-20230512225054684.png" alt="image-20230512225054684" style="zoom: 50%;" />
